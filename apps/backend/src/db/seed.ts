  ...
  if (Number(existingReports.count) === 0) {
    const dummyReports = [
      {
        ...
        latitude: "-6.1944",
        longitude: "106.8451",
        addressDetail: "Jl. Menteng Raya No. 25, Menteng, Jakarta Pusat, DKI Jakarta, Indonesia",
      ...
      },
      {
        ...
        latitude: "-6.2441",
        longitude: "106.7969",
        addressDetail: "Jl. Wijaya No. 10, Kebayoran Baru, Jakarta Selatan, DKI Jakarta, Indonesia",
      ...
      },
      {
        ...
        latitude: "-6.9215",
        longitude: "107.6070",
        addressDetail: "Jl. Asia Afrika No. 15, Sumur Bandung, Bandung, Jawa Barat, Indonesia",
      ...
      },
      {
        ...
        latitude: "-7.2575",
        longitude: "112.7521",
        addressDetail: "Jl. Pemuda No. 20, Genteng, Surabaya, Jawa Timur, Indonesia",
      ...
      },
      {
        ...
        latitude: "-6.9932",
        longitude: "110.4203",
        addressDetail: "Jl. Pandanaran No. 30, Semarang Tengah, Semarang, Jawa Tengah, Indonesia",
      ...
      },
      {
        ...
        latitude: "-7.7928",
        longitude: "110.3660",
        addressDetail: "Jl. Malioboro No. 5, Gedongtengen, Yogyakarta, DI Yogyakarta, Indonesia",
      ...
      },
      {
        ...
        latitude: "3.5952",
        longitude: "98.6722",
        addressDetail: "Jl. Gatot Subroto No. 8, Medan Petisah, Medan, Sumatera Utara, Indonesia",
      ...
      },
      {
        ...
        latitude: "-5.1477",
        longitude: "119.4327",
        addressDetail: "Jl. Sultan Hasanuddin No. 12, Ujung Pandang, Makassar, Sulawesi Selatan, Indonesia",
    ...
    for (const report of dummyReports) {
      ...
      await db.insert(schema.reports).values({
        ...reportData,
        mapUrl: reportData.latitude && reportData.longitude ? `https://www.google.com/maps?q=${reportData.latitude},${reportData.longitude}` : null,
